...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference("Feature.count") do
      post features_url, params: { feature: { name: @feature.name, service_id: @feature.service_id } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { name: @feature.name, service_id: @feature.service_id } }
